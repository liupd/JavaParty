package org.zp.tent.app.quartz.utils;

import org.quartz.*;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.zp.tent.app.quartz.exceptions.ScheduleException;
import org.zp.tent.app.quartz.model.ScheduleJob;
import org.zp.tent.app.quartz.quartz.JobFactory;
import org.zp.tent.app.quartz.quartz.JobSyncFactory;
import org.zp.tent.app.quartz.vo.ScheduleJobVo;
...
public class ScheduleUtils {
    ...
    public static void createScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) {
    	Class jobClass;
		try {
			jobClass = Class.forName(scheduleJob.getClassName());
		} catch (ClassNotFoundException e) {
			LOG.error("反射类名时异常", e);
            throw new ScheduleException("反射类名时异常");
		}
        createScheduleJob(scheduler, scheduleJob.getJobName(), scheduleJob.getJobGroup(), jobClass,
     ...
     */
    public static void createScheduleJob(Scheduler scheduler, String jobName, String jobGroup, Class<? extends Job> jobClass,
